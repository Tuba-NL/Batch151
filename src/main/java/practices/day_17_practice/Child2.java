...
public class Child2 extends Parent2 {
    /*
   extends yapılan class'lardaki tüm construktorların ilk
   satırında biz görmesek bile super() constructor vardır.
   super() constructor call vardır.
   dolayısıyla önce parent classtaki constructor ı çalıştırır.
 */   public Child2() {
     super();
