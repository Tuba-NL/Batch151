...
public class C03_Array {
     ...
     */
        ...
        for (int i = 0; i < arr1.length ; i++) {// distaki arraylerin kisa olaninin sayisinca donguye alacagim.

            if(arr1[i].length<arr2[i].length){// arr1`in i. index`indeki dis arrayin eleman uzunlugu ile
                                              // arr2`in i. index`indeki dis arrayin eleman uzunlugunu karsilastirdik.
                sinir = arr1[i].length;
            }else{
                sinir = arr2[i].length;
            }
