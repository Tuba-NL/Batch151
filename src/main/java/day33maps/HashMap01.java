...
public class HashMap01 {
    public static void main(String[] args) {
        ...
        System.out.println(getTheNumOfOccurrenceOfLetters(s));//{ =1, r=1, e=2, H=2, y=1, l=2, n=1, o=1}
    }
    ...
    NOT: 0Eger ciktiyi alfabetik siralamak istersek HashMap`leri TreeMap`lere cevirmeliyiz.
         */
    }
}
