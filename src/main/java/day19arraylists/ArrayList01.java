...
public class ArrayList01 {
    ...
    2)Array`lerinbir negatif yonu var; icine koyacagimiz eleman sayisini en bastan belirlemek zorundasiniz.
    3)Array`ler eleman sayisinda esnek degildirler, bu yuzden Java "ArrayList" adli yeni bir yapi olusturdu,
    bu yapi eleman sayisinda esnektir. Hic eleman koymazsaniz eleman sayisi sifir olarak ayarlar, 1000 eleman
    ...
    public static void main(String[] args) {
       ...
       // ArrayList nasil olusturulur?
        ...
        ages.add(12);
        ages.add(24);
        ages.add(9);//add() methodu elemanleri "giris sirasina"(insertion order) gore list`e yerlestirir.
        ...
        //3.Way:addAll() methodu bir list`i diger list`in icine yerlestirir.
        ages.addAll(price);
